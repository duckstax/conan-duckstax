...
| **otterbrix** | Open-source framework for analytical applications | 1.0.0a10-rc-10 |
...
conan create recipes/otterbrix/all --version=1.0.0a10-rc-10 \
  -o "actor-zeta/*:cxx_standard=17" \
  -s build_type=Release \
  --build=missing
```
